...
Word32 Inv_sqrt(G729DECODER * pgd,    /* (o) Q30 : output value   (range: 0<=val<1)           */
  Word32 L_x        /* (i) Q0  : input value    (range: 0<=val<=7fffffff)   */
);

void Log2(G729DECODER * pgd,
...
Word32 Pow2(G729DECODER * pgd,        /* (o) Q0  : result       (range: 0<=val<=0x7fffffff)   */
...
void Init_Decod_ld8k(G729DECODER *);

void Decod_ld8k(G729DECODER *,
 ...
 *--------------------------------------------------------------------------*/
  ...
  Word16 Pitch_ol(G729DECODER *,  /* (o)     : open loop pitch lag                        */
  ...
  Word16 Pitch_fr3(G729DECODER *, /* (o)     : pitch period.                              */
...
Word16 G_pitch(G729DECODER *,     /* (o) Q14 : Gain of pitch lag saturated to 1.2         */
...
void Dec_lag3(G729DECODER * pgd,       /* (o)     : return integer pitch lag                   */
...
void Pred_lt_3(G729DECODER * pgd,
...
Word16 Parity_Pitch(G729DECODER *, /* (o)    : parity bit (XOR of 6 MSB bits)             */
  Word16 pitch_index /* (i)    : index for which parity to compute          */
);

Word16 Check_Parity_Pitch(G729DECODER *, /* (o) : 0 = no error, 1= error                  */
...
void Lsp_qua_cs(G729DECODER *,
  Word16 flsp_in[M],  /* Q13 */
  Word16 lspq_out[M], /* Q13 */
  Word16 *code
);

void Lsp_expand_1(G729DECODER * pgd,
  Word16 buf[],     /* Q13 */
  Word16 gap        /* Q13 */
);

void Lsp_expand_2(G729DECODER * pgd,
  Word16 buf[],     /* Q13 */
  Word16 gap        /* Q13 */
);

void Lsp_expand_1_2(G729DECODER * pgd,
  Word16 buf[],     /* Q13 */
  Word16 gap        /* Q13 */
);

void Lsp_get_quant(G729DECODER * pgd,
  Word16 lspcb1[][M],    /* Q13 */
  Word16 lspcb2[][M],    /* Q13 */
  Word16 code0,
  Word16 code1,
...
void Lsp_get_tdist(G729DECODER *,
...
void Lsp_stability(G729DECODER * pgd,
  Word16 buf[]     /* Q13 */
);

void Relspwed(G729DECODER *,
  Word16 lsp[],                          /* Q13 */
  Word16 wegt[],                         /* normalized */
  Word16 lspq[],                         /* Q13 */
  Word16 lspcb1[][M],                 /* Q13 */
...
void Lsp_decw_reset(G729DECODER *);

void Lsp_iqua_cs(G729DECODER *,
  Word16 prm[],     /* (i)     : codes of the selected LSP                  */
  Word16 lsp_q[],   /* (o)     : Quantized LSP parameters                   */
  Word16 erase      /* (i)     : frame erase information                    */
);

void Lsp_prev_compose(G729DECODER * pgd,
  Word16 lsp_ele[], /* Q13 */
  Word16 lsp[],     /* Q13 */
  Word16 fg[][M],/* Q15 */
  Word16 freq_prev[][M],     /* Q13 */
...
void Lsp_prev_extract(G729DECODER * pgd,
  Word16 lsp[M],                 /* Q13 */
...
void Gain_predict(G729DECODER * pgd,
...
void Gain_update(G729DECODER * pgd,
  Word16 past_qua_en[],/* (i) Q10 :Past quantized energies                  */
  Word32 L_gbk12    /* (i) Q13 : gbk1[indice1][1]+gbk2[indice2][1]          */
);

void Gain_update_erasure(G729DECODER * pgd,
  Word16 past_qua_en[]/* (i) Q10 :Past quantized energies                   */
);
